...
public class Signup extends JFrame implements ActionListener{
    ...
    Signup(){
       ...
       ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("ASimulatorSystem/icons/logo.jpg"));
        ...
        JLabel l16 = new JLabel(i3); // Changed from l11 to l16
        l16.setBounds(20, 0, 70, 70);
        add(l16);
	...
	add(dateChooser);
        ...
        setLayout(null);
        l1.setBounds(240,5,400,30);
        add(l1);
        
        l2.setBounds(290,40,600,30);
        add(l2);
        
        l3.setBounds(100,70,100,30);
        add(l3);
        
        t1.setBounds(300,70,400,30);
        add(t1);
        
        l4.setBounds(100,110,200,30);
        add(l4);
        
        t2.setBounds(300,110,400,30);
        add(t2);
        
        l5.setBounds(100,150,200,30);
        add(l5);
        
        dateChooser.setBounds(300, 150, 400, 30);
        ...
        l7.setBounds(100,230,200,30);
        add(l7);
        
        t3.setBounds(300,230,400,30);
        add(t3);
        
        l8.setBounds(100,270,200,30);
        add(l8);
        
        r3.setBounds(300,270,100,30);
        add(r3);
        
        r4.setBounds(450,270,100,30);
        add(r4);
        
        r5.setBounds(635,270,100,30);
        add(r5);
        
        
        
        l9.setBounds(100,310,200,30);
        add(l9);
        ...
        t7.setBounds(300,430,400,30);
        add(t7);
        
        b.setBounds(620,470,80,30);
        add(b);
